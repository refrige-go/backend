...
//    public ResponseEntity<Map<String, Object>> receiveLocation(@RequestBody LocationToAiDTO locationToAiDto) {
//        double latitude = locationToAiDto.getLatitude();
//        double longitude = locationToAiDto.getLongitude();
//
